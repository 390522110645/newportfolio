...
const Page2 = () => {
    ...
    return (
        <>
        <div id="section2" className="bg-white text-center text-black p-35">
            <h3 className="text-gray-500 text-2xl">© chaitanya.dev 2025 | design and developed</h3>
            <div  className="rotateText  mt-20">
                <b><h1 className="text-[15vw] text-black  leading-[12vw]" >IMPACTFULL</h1></b>
            </div>
             <div className="rotateText">
                <b><h1 className="text-[15vw] text-black  leading-[12vw]" >DESIGN</h1></b>            </div>
             <div className="rotateText">
                <b><h1 className="text-[15vw] text-black  leading-[14vw]" >IS THE</h1></b>
            </div>
             <div className="rotateText">
                <b><h1 className="text-[15vw] text-black  leading-[12vw]" >DESIGN</h1></b>            </div>
             <div className="rotateText">
                <b><h1 className="text-[15vw] text-black  leading-[14vw]" >THAT</h1></b>
            </div>
             <div className="rotateText">
               <b><h1 className="text-[15vw] text-black  leading-[14vw]" >WORKS!</h1></b>
            </div>
            <div className="flex item-center justify-center  scale-75  ">
<svg className="fill-nune h-10 w-[100vw]  " preserveAspectRatio="xMidYMid meet" databbox="4 0 2028.339 83" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2037 91" height="91" width="20" datatype="ugc" role="img" aria-label="Tesla, Figma, Wix Studio, Google+, BeHance monochrome Logo Design by Anzo Studio ">
    <g>
        ...
        <g clipPath="url(#96a8edfe-3cce-4a8a-8fa1-014070af92c2_comp-lmyox36t2)">
            ...
            <div className="h-1 pb-1 relative left-1/2 w-1/2 -translate-x-1/2 bg-black">
            </div>
            <div className="pb-10">
